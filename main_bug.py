...
"""
建立 name_list，即包含姓名、學號、email 的清單。
...
for r in range(sheet.nrows):
    ...
    if r < 1:
        ...
        name = (sheet.cell_value(r,0), sheet.cell_value(r,1), sheet.cell_value(r,2))
        # 將同學名字中的亂碼修正
    ...
    for col in range(0,5):
        if col == 2:
            ...
            if haveSeat < name_list_num and haveSeat - _328num - _326num < max_seat[2]:
                # 尚未分配完所有同學
                macSeat.write(row, col, name_list[haveSeat][0], format3)
...
# 每間教室：一張當作座位表給學生看，一張留於簽到時，助教可以拿著核對名字
...
sheets.insert(2, sheets.pop(10))  
sheets.insert(5, sheets.pop(11)) 
sheets.insert(8, sheets.pop(12)) 
wb._sheets = sheets
